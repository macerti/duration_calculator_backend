...
**Status: IMMEDIATE INCIDENT CLOSED — Mahdi confirmed Microsoft sign-in works again after applying the migration manually. The underlying systemic gap (no automated way to apply migrations to production) is still OPEN — see item 2 in "NOT DONE / open" below, now the top-priority follow-up.**
